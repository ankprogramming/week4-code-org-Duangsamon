...
ได้ใช้การ วนลูป เพื่อให้ง่ายต่อการใช้โค้ดให้น้อยลง และให้ตัวละครเดินตามทางที่เรากำหนดโดยมีบล้อคของโค้ดเป็นตัวให้เราใช้โค้ด ว่าใช้ได้ กี่บล้อค
...
ได้ใช้การทำงานแบบต่างๆสร้างเส้นทางเพื่อให้ตัวละครดินไปตามทางได้
...
ได้กำหนดโค้ดเพื่อสร้างและให้ตัวละครเดินหน้า ถอยหลัง เพื่อทำตามที่ด่านกำหนด
...
$$$$4
ใช้โค้ดสร้างตัวละครและกำหนดด่านต่างๆๆ เพื่อให้ตัวละครทำตามและผ่านด่าน
